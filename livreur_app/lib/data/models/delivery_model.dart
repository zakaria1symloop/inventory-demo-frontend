...
String formatQtyPieces(int totalPieces, int piecesPerPackage) {
  ...
  if (cartons > 0 && pieces > 0) return '$cartons كرتون + ${pieces}ق';
  if (cartons > 0) return '$cartons كرتون';
  if (pieces > 0) return '${pieces}ق';
  return '0';
}
...
class OrderItemModel {
  ...
  String get formattedConfirmed => formatQtyPieces(quantityConfirmed, piecesPerPackage);
  String get formattedDelivered => formatQtyPieces(quantityDelivered, piecesPerPackage);
  String get formattedReturned => formatQtyPieces(quantityReturned, piecesPerPackage);
