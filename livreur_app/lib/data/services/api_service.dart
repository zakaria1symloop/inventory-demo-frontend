...
class ApiService {
    ...
    _dio.interceptors.add(InterceptorsWrapper(
      onRequest: (options, handler) async {
        ...
        if (tenantId != null) {
          ...
          debugPrint('[API] WARNING: No tenant_id in SharedPreferences!');
        }
  ...
  Future<Response> getCaisseTransactions(int caisseId, {int page = 1, String? type}) async {
    ...
    return _dio.get('/caisses/$caisseId/transactions', queryParameters: params);
  }

  // Stats
  Future<Response> getLivreurStats({String? fromDate, String? toDate}) async {
    final params = <String, dynamic>{};
    if (fromDate != null) params['from_date'] = fromDate;
    if (toDate != null) params['to_date'] = toDate;
    return _dio.get(ApiConstants.livreurStats, queryParameters: params);
  }
}
