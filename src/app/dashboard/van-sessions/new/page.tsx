...
import { vanSessionsApi, usersApi, vehiclesApi, warehousesApi, productsApi } from '@/lib/api';
...
export default function NewVanSessionPage() {
  ...
  const fetchData = async () => {
    try {
      const [livreursRes, vehiclesRes, warehousesRes, productsRes] = await Promise.all([
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await vanSessionsApi.create({
