    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">إدارة سائقي التوصيل والبائعين والكاشفان</p>
        </div>
      ...
      <div className="flex gap-2">
        {[
          ...
          { value: 'seller', label: 'البائعين' },
          { value: 'cashvan', label: 'كاشفان' },
        ].map((tab) => (
          <button
            key={tab.value}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            >
              ...
              <option value="cashvan">كاشفان</option>
            </select>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
