...
const planColors: Record<string, { bg: string; border: string; badge: string; text: string }> = {
  ...
  starter:  { bg: 'bg-blue-50', border: 'border-blue-200', badge: 'bg-blue-100 text-blue-700', text: 'text-blue-700' },
  pro:      { bg: 'bg-violet-50', border: 'border-violet-200', badge: 'bg-violet-100 text-violet-700', text: 'text-violet-700' },
  business: { bg: 'bg-amber-50', border: 'border-amber-200', badge: 'bg-amber-100 text-amber-700', text: 'text-amber-700' },
};
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm">
          اختر الخطة المناسبة لحجم أعمالك. الدفع آمن عبر SlickPay.
        </p>
      </div>
