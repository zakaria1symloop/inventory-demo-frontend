...
export default function MobileAppPage() {
  ...
  const handleWhatsAppShare = (name: string, downloadUrl: string) => {
    const message = `\u{1F4F2} حمّل ${name} من هنا:\n${downloadUrl}`;
  ...
  return (
    <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ارفع وأدر تطبيقات الموبايل — شاركها مع فريقك بالرابط أو رمز QR
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/40 rounded-xl flex items-start gap-3 anim-fade-up" style={{ animationDelay: '80ms' }}>
        <span className="text-xl shrink-0 mt-0.5">{'\u{1F4A1}'}</span>
              ...
              <div className="p-5 sm:p-6 space-y-5">
                ...
                {hasApp ? (
                  <>
                    ...
                    {/* Admin actions: re-upload / delete */}
